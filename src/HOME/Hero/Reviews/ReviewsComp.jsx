...
function ReviewsComp({text, tag, loc, time, img, name, rating}) {
    ...
    // }
    return (
        <div className="max-w-[350px]  h-[300px] bg-white w-[50%] min-w-[300px] flex-shrink-0 p-[15px] rounded-2xl border-gray-200 relative flex flex-col justify-between">
          ...
          <div className="">
            {Array.from({ length: rating }).map((_, i) => <i className="fa-solid fa-star text-[#fdc700]"></i>)}
