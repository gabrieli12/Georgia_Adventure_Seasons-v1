  ...
  return (
    <div  className={`w-75 bg-white pb-5  flex flex-col justify-start items-start gap-3`}>
      ...
      <div className='w-full h-full flex flex-col justify-start items-start gap-3 px-5 py-3'>
        ...
        <p>{description}</p>
        <div className='flex items-center justify-center gap-2 cursor-pointer w-full border-1 border-[#09ad27] mt-5 bg-green-50 p-2 hover:bg-amber-100 duration-300 '>
