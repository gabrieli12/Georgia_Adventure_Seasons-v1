...
import FaqSection from './FaqSection'; // დარწმუნდი რომ გზა სწორია
...
function Faq() {
    ...
    // აქ შენი მასივები (generalQuestions, skiQuestions და ა.შ.)
            ...
            <div className="w-[80%] overflow-hidden flex  justify-between pl-7.5 max-sm:pl-0 ">
                <div className="w-full  flex flex-col pl-7.5 max-sm:pl-0 ">
                    ...
                    <div className="pt-3.75 relative">
                        <FaqSection title="GENERAL" questions={generalQuestions} defaultOpen={true} />
                        <hr className="border-t border-gray-300 " />

                        <FaqSection title="SKI" questions={skiQuestions} />
                        <hr className="border-t border-gray-300 " />

                        <FaqSection title="PARAGLIDING" questions={paraglidingQuestions} />
                        <hr className="border-t border-gray-300 " />

                        <FaqSection title="QUAD BIKE TOURS" questions={quadBikeQuestions} />
                        <hr className="border-t border-gray-300 " />

                        <FaqSection title="HORSE RIDING" questions={horseRidingQuestions} />
                        <hr className="border-t border-gray-300 " />

                        <FaqSection title="WHITE WATER RAFTING" questions={raftingQuestions} />
                        <hr className="border-t border-gray-300 " />

                        <FaqSection title="WINTER SPORTS" questions={winterSportsQuestions} />
                        <hr className="border-t border-gray-300 " />
