...
const AdventureCards = [
...

  {
    ...
    imgAlt: "White water rafting adventure on Aragvi river near Pasanauri Georgia",
  ...
  // სათხილამურო და სნოუბორდის გაკვეთილები
  {
    ...
    imgAlt: "Ski and snowboard lessons in Gudauri with professional instructors for beginners and advanced skiers",
    buttonText: "Book Adventure",
    rightText: [
...

  {
    ...
    imgAlt: "Full ski and snowboard equipment rental shop in Gudauri with premium winter gear",
    buttonText: "Book Adventure",
    rightText: [
      "💎 Premium Gear",
      "✨ Perfectly Tuned",
...

  {
    ...
    imgAlt: "Tandem paragliding flight over mountains in Gudauri and Ananuri Georgia",
    buttonText: "Book Adventure",
    rightText: [
...

  {
    ...
    imgAlt: "Thrilling jetski adventure tour on the water Ananuri",
    buttonText: "Book Adventure",
    rightText: [
      "✅ Professional guide",
      "💯 Full safety equipment",
  ...
  // ================= MotorBoat Adventure =================
  {
    ...
    imgAlt: "Motorboat sightseeing tour on the Zhinvali reservoir Ananuri",
    buttonText: "Book Adventure",
    rightText: [
      "✅ Professional guide",
      "💯 Full safety equipment",
...

  {
    ...
    imgAlt: "Snowmobile adventure tour in Gudauri mountains with professional guide and breathtaking winter views",
    buttonText: "Book Adventure",
    rightText: [
  ...
  // ================= ATV Mountain Adventure =================
  {
    ...
    imgAlt: "Off-road ATV mountain adventure through scenic trails in Gudauri and Pasanauri",
    buttonText: "Book Adventure",
    rightText: [
      "🧑‍🏫 Professional Guide",
      "🛡 Safety Briefing",
