    ...
    return (
        <>
            ...
            <header className={`flex justify-around fixed items-center text-[16px] w-full text-white  z-50 transition-all duration-500 ease-out flex-col ${scrolled ?
                ...
                : "bg-transparent "}   
                `} >
            <div className={`h-[38px] w-full bg-[#0B1220]/80 flex justify-center items-center ${add ? '' : 'hidden'}`}>
            <p className='text-white text-[14px] font-[400] opacity-[80%] p-2'> Website is under update. Prices may vary — </p><span className='font-[500] underline text-white text-[14px] font-[400]  opacity-[95%] '>
                <a href={whatsappLink} className="text-sm" onClick={handleWhatsAppClick} target="_blank" rel="noopener noreferrer">
