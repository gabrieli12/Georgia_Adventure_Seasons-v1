...
function Menu() {
    ...
    return (
        ...
        <div className="h-[100px] flex items-center justify-evenly fixed w-full bg-white top-0 z-50 ">

            <div className='flex items-center justify-center gap-3  ' >
                <img className="w-[90px]" src="/Georgia Adventure Logo for images.png" alt="" />

                <div className='flex items-start flex-col'>
                    <h1 className='text-green-700 text-lg font-[500]  '>Georgia Adventure <br /> Seasons</h1>
                </div>
            ...
            <div className='flex gap-[50px] text-[18px] text-gray-600 max-lg:hidden '>
                ...
                <h3 className=' hover:text-green-700 cursor-pointer '>Activites</h3>
