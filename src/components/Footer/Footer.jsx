                ...
                <div className="footer-top grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="w-full">
                        ...
                        <div className="flex flex-row md:flex-col md:space-y-2 gap-2">
                            ...
                            <span className="w-fit inline-flex items-center rounded-lg bg-blue-900 leading-none px-2 py-1 text-xs font-medium text-blue-300 border border-solid border-blue-700">
                                <i className="fa-solid fa-award text-[10px] mr-2"></i> Tourism Award Winner
                            </span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-2 mt-3">
                            ...
                            <ul className="flex items-center gap-5">
                                <li><a href="https://www.facebook.com/profile.php?id=61580045558141" aria-label="Home"><i className="fa-brands fa-facebook-f text-gray-400 hover:text-white"></i></a></li>
                                <li><a href="https://www.instagram.com/georgia_adventure_seasons/" aria-label="Home"><i className="fa-brands fa-instagram text-gray-400 hover:text-white"></i></a></li>
                                <li><a href="https://www.youtube.com/@GeorgiaAdventureSeasons" aria-label="Home"><i className="fa-brands fa-youtube text-gray-400 hover:text-white"></i></a></li>
                                <li><a href="https://www.tiktok.com/@georgiaadventureseasons" aria-label="Home"><i className="fa-brands fa-tiktok text-gray-400 hover:text-white"></i></a></li>
                            </ul>
                        </div>
                    </div>
